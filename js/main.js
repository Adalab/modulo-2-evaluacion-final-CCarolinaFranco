  ...
  characterList.forEach((character) => {
    ...
    <li id ="${character._id}" class="liCards js_liCards">
      ...
      <div class="personajes">
        ...
        <p ><a href ="${character.sourceUrl}">personaje nuevo</a></p>
      </div>
    </li>`;
...
////                                            Favoritas repasar de nuevo son mucho pasos


///sobre lo que se hace el evento click y con este funcionamiento se habilita a los fav con el find
function licardClick(event) {
